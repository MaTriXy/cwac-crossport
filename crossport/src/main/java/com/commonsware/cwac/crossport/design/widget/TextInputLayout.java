...
public class TextInputLayout extends LinearLayout {
      ...
      if (enabled) {
        ...
        if (useDefaultColor) {
          ...
          TextViewCompat.setTextAppearance(
              mErrorView, android.R.style.TextAppearance_Material_Caption);
  ...
  public void setPasswordVisibilityToggleDrawable(@DrawableRes int resId) {
    setPasswordVisibilityToggleDrawable(
        resId != 0 ? getContext().getDrawable(resId) : null);
  }
  ...
  // MLM ported over from appcompat-v7 AppCompatDrawableManager

  private static class ColorFilterLruCache extends
  ...
  static PorterDuffColorFilter getPorterDuffColorFilter(int color, PorterDuff.Mode mode) {
