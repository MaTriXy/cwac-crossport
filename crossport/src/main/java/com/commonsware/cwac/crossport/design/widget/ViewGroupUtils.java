...
class ViewGroupUtils {
  ...
  /**
   * This is a port of the common {@link ViewGroup#offsetDescendantRectToMyCoords(View,
   * Rect)} from the framework, but adapted to take transformations into account.
